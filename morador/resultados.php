...
// Pega o ID do condomínio do morador logado da sessão
// $idCondominio = $_SESSION['id_usuario']['id_condominio'] ?? 0;
...
// print("\n\n\n\ID do condomínio: " . $_SESSION['id_usuario']['id_condominio'] . "\n"); // Debugging
...
if ($idSindico > 0) {
    ...
    $idCondominio = -1;
    print("Erro ao obter ID do condomínio do síndico.");
    exit;
}

include '../includes/header.php';
include '../includes/navbar-morador.php'; // navbar para moradores
?>
...
// Carrega resultados automaticamente do condomínio do morador
carregarResultados();
</script>
